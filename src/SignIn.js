    ...
    <div className="container top">
      ...
      <div className="container sign" id="body">
        <center>
          ...
          <p id="emailveri" onClick={sendverificationlink}>
            {verifydata}
          </p>
          ...
          <p className="merge">
            <p style={{ marginBottom: "10px" }}>
              <Link to="/ReactUrlShortner/signup">Signup</Link>
            </p>
            <p className="skip" style={{ cursor: "pointer" }} onClick={skip}>
              Skip for now
            </p>
            <p className="s" style={{ cursor: "pointer" }}>
              <Link to="/ReactUrlShortner/reset">Forget password</Link>
            </p>
          </p>
          <br />
        </center>
