...
const Reset = ()=>{
    ...
    return(
        <div className="container top">
            <h1 className="text-center font-bold" style={{color:"white"}}>Forget Password</h1>
            <div className="container sign1">
                ...
                <br/>
                <h5>or</h5>
                <h5 className="resetlink" style={{marginBottom:"10px"}}><Link to="/ReactUrlShortner/">SignIn</Link></h5>
                <br/>
                </center>
            </div>
        </div>
